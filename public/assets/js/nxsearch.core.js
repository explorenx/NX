			...
			backToTop: {
				...
				init: function(config){
					...
					this.btn = $('<button></button>', {
						...
						html: '<span class="lnr"><i class="fa fa-arrow-up" aria-hidden="true"></i></span>'
					});
...
backToBottom: {
				...
				bindEvents: function(){
					...
					$(window).on('scroll.backtobottom', { self: this}, this.toggleBtn);
				...
				toggleBtn: function(e){
					...
					if($this.scrollBottom() > self.config.breakpoint && !self.btn.hasClass(self.config.cssPrefix + 'inview')){
