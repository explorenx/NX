...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/carousel/carousel.html",
    ...
    "    <a ng-click=\"prev()\" class=\"left carousel-control\" ng-show=\"slides().length > 1\"><span class=\"middle-arrow\"  ng-show=\"slides().length > 1\">&lsaquo;</span></a>\n" +
    "    <a ng-click=\"next()\" class=\"right carousel-control\" ng-show=\"slides().length > 1\"><span class=\"middle-arrow\"  ng-show=\"slides().length > 1\">&rsaquo;</span></a>\n" +
    "</div>\n" +
    "");
}]);
